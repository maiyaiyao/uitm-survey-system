                ...
                <div class="main-content">
                    ...
                    <nav aria-label="breadcrumb" class="mb-4">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-dark">Control <?php echo htmlspecialchars($sec_id); ?></li>
                        </ol>
                    </nav>
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-4">
                            <div class="stat-card">
                                <div class="stat-label mb-2">Total Controls</div>
                    ...
                    <div class="mb-4">
                        <input type="text" id="searchInput" class="form-control form-control-lg search-input" placeholder="Search controls...">
                    </div>

                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 fw-bold">Controls List</h5>
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($controls as $con): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-semibold text-secondary"><?php echo htmlspecialchars($con['sub_con_name']); ?></td>
                                                <td>
                                                    <?php if ($isMapped): ?>
                                                ...
                                                <td class="text-end pe-4">
                                                    <?php if ($isMapped): ?>
                                                        <a href="map_iso.php?type=control&id=<?php echo urlencode($con['sub_con_ID']); ?>" class="btn btn-sm btn-link text-info" title="View Map">
                                                            <i class="bi bi-link-45deg"></i>
                                                        </a>
                                                    <?php else: ?>
                                                        <a href="map_iso.php?type=control&id=<?php echo urlencode($con['sub_con_ID']); ?>" class="btn btn-sm btn-link text-secondary opacity-50" title="Map Now">
                                                            <i class="bi bi-link-45deg"></i>
                                                        </a>
                                                    <?php endif; ?>

                                                    <a href="edit-control.php?id=<?php echo urlencode($con['sub_con_ID']); ?>" class="btn btn-sm btn-link text-primary" title="Edit">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-link text-danger" 
                                                            onclick="confirmDelete('control', '<?php echo $con['sub_con_ID']; ?>')" 
                                                            title="Delete">
